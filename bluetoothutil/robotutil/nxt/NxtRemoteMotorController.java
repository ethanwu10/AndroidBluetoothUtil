package ethanwu10.github.bluetoothutil.robotutil.nxt;

import ethanwu10.github.bluetoothutil.BluetoothSppClient;
import ethanwu10.github.bluetoothutil.robotutil.MotorController;
import ethanwu10.github.bluetoothutil.robotutil.MotorState;
...
public class NxtRemoteMotorController implements MotorController {
    ...
    public void setMotorStates(MotorState[] motorStates) {
        ...
        for (MotorState motorState : motorStates) {
            ...
            byte motorRegMode = 0;
            if (motorState.motor != Motor.ALL && (motorState.motor < 0 || motorState.motor > 2)) {
